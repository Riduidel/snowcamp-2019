...
** Idéalement sur une VM GCE
* Créer le cluster Kubernetes `jx create cluster gke --cluster-name=snowcamp-2019 --project-id=snowcamp-2019-223915 --min-num-nodes=5 --max-num-nodes=10 --zone=europe-west1-d --machine-type=n1-standard-2 --gitops=true --batch-mode=true`
