...
=== Puis on écrit un peu de code

[NOTE.speaker]
--
**Nicolas**
Lancer le script `src\build\1-write-reader-code.bat`
Il crée une branche avec du vrai code.
Il faut ensuite faire la pull request et laisser Jenkins la builder.
