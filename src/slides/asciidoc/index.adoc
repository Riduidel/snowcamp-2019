...
[source,sh]
----
include::../../build/install.sh[lines=3]
----
...
[source,bat]
----
include::../../build/install.bat[lines=2]
----
...
[source,bat]
----
include::../../build/install.bat[lines=5..7]
----
...
[source,bat]
----
include::../../build/install.bat[lines=10..12]
----
...
[source,bat]
----
include::../../build/install.bat[lines=15..20]
----
...
[source]
----
curl -v -X POST --data "@src/k8s/kafka/kafka-connect-elastic-test.json" -H "Content-Type: application/json" http://localhost:18083/connectors
----
--
...
[source,bat]
----
include::../../build/install.bat[lines=23]
----
...
Là, TODO il faut cherry-picker la version "qui marche" dans la version officielle